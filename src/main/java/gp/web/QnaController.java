...
public class QnaController {
    ...
    public String myqnamain(Model model, @RequestParam(value = "page", defaultValue = "1")Integer pageNum){
    ...
    public String qnasubmit(@ModelAttribute QnaDto qnaDto){
    ...
    @PostMapping("/adminqnadetail/{qnakey}")
    public String qnaanswer(@ModelAttribute QnaDto qnaDto){
        qnaService.saveQna(qnaDto);
        return ("redirect:/adminqna");

    }
    /*@DeleteMapping("/adminqna/{qnakey}")
    public String delete(@PathVariable("qnakey") Long qnakey) {
